...
class Sample
{
    public Sample(string[] args)
    {
        ...
        chart.SelectData(ws.Cells.GetSubrangeAbsolute(0, 0, numberOfSeries, numberOfPoints));
        ...
        var names = new[] { "John Doe", "Fred Nurk", "Hans Meier", "Ivan Horvat" };
        ...
        for (int i = 0, startYear = DateTime.Now.Year - numberOfPoints; i<numberOfPoints; ++i)
        {
